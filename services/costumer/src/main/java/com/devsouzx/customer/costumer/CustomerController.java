...
public class CustomerController {
    ...
    public ResponseEntity<Boolean> existsById(
            @PathVariable("customer-id") String costumerId
    ) {
        return ResponseEntity.ok(this.service.existsById(costumerId));
    }
    ...
    public ResponseEntity<CustomerResponse> findById(
        ...
        return ResponseEntity.ok(this.service.findById(costumerId));
    }
